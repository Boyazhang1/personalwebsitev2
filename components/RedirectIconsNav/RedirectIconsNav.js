  ...
  return (
    <div className={styles.redirectIconsNavContainer}>
      <a
        rel="noreferrer"
        target="_blank"
        href="https://linkedin.com/in/boyazhang1"
      >
        <img src="linkedin-svgrepo-com.svg"></img>
      </a>
      <a rel="noreferrer" target="_blank" href="https://github.com/boyazhang1">
        <img src="github-svgrepo-com.svg"></img>
      </a>
      <a rel="noreferrer" target="_blank" href="mailto:b429zhang@uwaterloo.ca">
